...
static void client_registration_callback(char const *name, int reg, void *arg) {
  goClientRegistration((char *)name, reg, (uintptr_t)arg);
}
...
int jack_set_client_registration_callback_go(jack_client_t *client,
                                             uintptr_t arg) {
  return jack_set_client_registration_callback(
      client, client_registration_callback, (void *)arg);
}
